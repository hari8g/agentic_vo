...
Agentic separately records basic usage like the number of messages people are sending. If you'd like to disable Agentic metrics, you may do so in Agentic's Settings.
`;
