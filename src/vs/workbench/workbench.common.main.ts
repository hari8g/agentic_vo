...
//#region --- Agentic
import './contrib/agentic/browser/agentic.contribution.js'; // Agentic added this
//#endregion
...
// Chat
// Agentic - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
