	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'workbench.sideBar.location': {
				...
				'enum': ['left', 'right'],
				'default': 'left',
				'description': localize('sideBarLocation', "Controls the location of the primary side bar and activity bar. They can either show on the left or right of the workbench. The Agentic side bar will show on the opposite side of the workbench.")
			},
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				...
				'default': 'default',
				'markdownDescription': localize({ comment: ['This is the description for a setting'], key: 'activityBarLocation' }, "Controls the location of the Activity Bar relative to the Primary and Agentic Side Bars."), // Agentic side bar
				'enumDescriptions': [
					localize('workbench.activityBar.location.default', "Show the Activity Bar on the side of the Primary Side Bar and on top of the Agentic Side Bar."), // Agentic side bar
					localize('workbench.activityBar.location.top', "Show the Activity Bar on top of the Primary and Agentic Side Bars."), // Agentic side bar
					localize('workbench.activityBar.location.bottom', "Show the Activity Bar at the bottom of the Primary and Agentic Side Bars."), // Agentic side bar
					localize('workbench.activityBar.location.hide', "Hide the Activity Bar in the Primary and Agentic Side Bars.") // Agentic side bar
				],
			},
			...
			'workbench.hover.delay': {
				...
				'default': 300, // Agentic changed this from isMacintosh ? 1500 : 500,
				'minimum': 0
			},
