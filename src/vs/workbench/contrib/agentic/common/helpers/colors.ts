...
// gets converted to --vscode-agentic-greenBG, see agentic.css, asCssVariable
registerColor('agentic.greenBG', configOfBG(acceptBG), '', true);
registerColor('agentic.redBG', configOfBG(rejectBG), '', true);
registerColor('agentic.sweepBG', configOfBG(sweepBG), '', true);
registerColor('agentic.highlightBG', configOfBG(highlightBG), '', true);
registerColor('agentic.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
