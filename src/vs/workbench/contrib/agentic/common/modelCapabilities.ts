...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './agenticSettingsTypes.js';
...
export type AgenticStaticModelInfo = { // not stateful
	// Agentic uses the information below to know how to handle each model.
...
type AgenticStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: AgenticStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<AgenticStaticModelInfo>) => (AgenticStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies AgenticStaticModelInfo
...
} as const satisfies { [s: string]: Partial<AgenticStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: AgenticStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<AgenticStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: AgenticStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: AgenticStaticModelInfo }

const anthropicSettings: AgenticStaticProviderInfo = {
...
const openAISettings: AgenticStaticProviderInfo = {
...
const xAISettings: AgenticStaticProviderInfo = {
...
const geminiSettings: AgenticStaticProviderInfo = {
...
const deepseekSettings: AgenticStaticProviderInfo = {
...
const mistralSettings: AgenticStaticProviderInfo = {
...
const groqSettings: AgenticStaticProviderInfo = {
...
} as const satisfies Record<string, AgenticStaticModelInfo>
const googleVertexSettings: AgenticStaticProviderInfo = {
...
const microsoftAzureSettings: AgenticStaticProviderInfo = {
...
const awsBedrockSettings: AgenticStaticProviderInfo = {
...
const vLLMSettings: AgenticStaticProviderInfo = {
...
const lmStudioSettings: AgenticStaticProviderInfo = {
...
const ollamaSettings: AgenticStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: AgenticStaticProviderInfo = {
...
const liteLLMSettings: AgenticStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: AgenticStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: AgenticStaticProviderInfo } = {
