...
export class MetricsService implements IMetricsService {
	...
	constructor(
		...
		this.metricsService = ProxyChannel.toService<IMetricsService>(mainProcessService.getChannel('agentic-channel-metrics'));
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'agenticDebugInfo',
			f1: true,
			title: localize2('agenticMetricsDebug', 'Agentic: Log Debug Info'),
		});
	}
