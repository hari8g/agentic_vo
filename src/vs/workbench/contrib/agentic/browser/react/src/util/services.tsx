...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/agentic/common/agenticSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { AgenticSettingsState } from '../../../../../../../workbench/contrib/agentic/common/agenticSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/agentic/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/agentic/common/refreshModelService.js';
import { IAgenticSettingsService } from '../../../../../../../workbench/contrib/agentic/common/agenticSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/agentic/browser/extensionTransferService.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/agentic/common/metricsService.js'
...
let settingsState: AgenticSettingsState
const settingsStateListeners: Set<(s: AgenticSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IAgenticSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		agenticCommandBarService: accessor.get(IAgenticCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, agenticCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		agenticCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		agenticCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IAgenticSettingsService: accessor.get(IAgenticSettingsService),
		...
		IAgenticModelService: accessor.get(IAgenticModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IAgenticCommandBarService: accessor.get(IAgenticCommandBarService),
		...
		IJiraTicketService: accessor.get(IJiraTicketService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Agentic useAccessor was called before _registerServices!`)
	}
