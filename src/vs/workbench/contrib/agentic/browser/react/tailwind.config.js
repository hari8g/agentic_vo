	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--agentic-fg-1)',
						'--tw-prose-headings': 'var(--agentic-fg-1)',
						'--tw-prose-lead': 'var(--agentic-fg-2)',
						'--tw-prose-links': 'var(--agentic-link-color)',
						'--tw-prose-bold': 'var(--agentic-fg-1)',
						'--tw-prose-counters': 'var(--agentic-fg-3)',
						'--tw-prose-bullets': 'var(--agentic-fg-3)',
						'--tw-prose-hr': 'var(--agentic-border-4)',
						'--tw-prose-quotes': 'var(--agentic-fg-1)',
						'--tw-prose-quote-borders': 'var(--agentic-border-2)',
						'--tw-prose-captions': 'var(--agentic-fg-3)',
						'--tw-prose-code': 'var(--agentic-fg-0)',
						'--tw-prose-pre-code': 'var(--agentic-fg-0)',
						'--tw-prose-pre-bg': 'var(--agentic-bg-1)',
						'--tw-prose-th-borders': 'var(--agentic-border-4)',
						'--tw-prose-td-borders': 'var(--agentic-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'agentic-bg-1': 'var(--agentic-bg-1)',
				'agentic-bg-1-alt': 'var(--agentic-bg-1-alt)',
				'agentic-bg-2': 'var(--agentic-bg-2)',
				'agentic-bg-2-alt': 'var(--agentic-bg-2-alt)',
				'agentic-bg-2-hover': 'var(--agentic-bg-2-hover)',
				'agentic-bg-3': 'var(--agentic-bg-3)',


				'agentic-fg-0': 'var(--agentic-fg-0)',
				'agentic-fg-1': 'var(--agentic-fg-1)',
				'agentic-fg-2': 'var(--agentic-fg-2)',
				'agentic-fg-3': 'var(--agentic-fg-3)',
				// 'agentic-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'agentic-fg-4': 'var(--agentic-fg-4)',

				'agentic-warning': 'var(--agentic-warning)',

				'agentic-border-1': 'var(--agentic-border-1)',
				'agentic-border-2': 'var(--agentic-border-2)',
				'agentic-border-3': 'var(--agentic-border-3)',
				'agentic-border-4': 'var(--agentic-border-4)',

				'agentic-ring-color': 'var(--agentic-ring-color)',
				'agentic-link-color': 'var(--agentic-link-color)',
