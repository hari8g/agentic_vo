...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@IAgenticModelService agenticModelService: IAgenticModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@IAgenticCommandBarService private readonly commandBarService: IAgenticCommandBarService,
		...
		this.callTool = {
			read_file: async ({ uri, startLine, endLine, pageNumber }) => {
				...
				await agenticModelService.initializeModel(uri)
				const { model } = await agenticModelService.getModelSafe(uri)
		...
		this.stringOfResult = {
			...
			search_in_file: (params, result) => {
				const { model } = agenticModelService.getModel(params.uri)
			...
			edit_file: (params, result) => {
				const lintErrsString = (
					this.agenticSettingsService.state.globalSettings.includeToolLintErrors ?
