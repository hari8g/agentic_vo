...
import { Diff, DiffArea, AgenticFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	revealFileInEditor(uri: URI): Promise<void>;
	...
	// testDiffs(): void;
	getAgenticFileSnapshot(uri: URI): AgenticFileSnapshot;
	restoreAgenticFileSnapshot(uri: URI, snapshot: AgenticFileSnapshot): void;
}
