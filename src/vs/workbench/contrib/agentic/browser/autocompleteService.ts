...
// The extension this was called from is here - https://github.com/agenticeditor/agentic/blob/autocomplete/extensions/agentic/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'agentic.autocompleteService'
