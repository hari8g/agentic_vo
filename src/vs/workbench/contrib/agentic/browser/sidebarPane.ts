...
// ---------- Register viewpane inside the agentic container ----------

// const agenticThemeIcon = Codicon.symbolObject;
// const agenticViewIcon = registerIcon('agentic-view-icon', agenticThemeIcon, localize('agenticViewIcon', 'View icon of the Agentic chat view.'));

// called VIEWLET_ID in other places for some reason
export const AGENTIC_VIEW_CONTAINER_ID = 'workbench.view.agentic'
export const AGENTIC_VIEW_ID = AGENTIC_VIEW_CONTAINER_ID

// Register view container
const viewContainerRegistry = Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry);
const container = viewContainerRegistry.registerViewContainer({
	id: AGENTIC_VIEW_CONTAINER_ID,
	title: nls.localize2('agenticContainer', 'Chat'), // this is used to say "Agentic" (Ctrl + L)
...
viewsRegistry.registerViews([{
	...
	// containerIcon: agenticViewIcon,
	name: nls.localize2('agenticChat', ''), // this says ... : CHAT
...
// open sidebar
export const AGENTIC_OPEN_SIDEBAR_ACTION_ID = 'agentic.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: AGENTIC_OPEN_SIDEBAR_ACTION_ID,
			title: 'Open Agentic Sidebar',
		})
	}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupAgenticSidebar';
	constructor(
		@ICommandService private readonly commandService: ICommandService,
	) {
		this.commandService.executeCommand(AGENTIC_OPEN_SIDEBAR_ACTION_ID)
	}
}
